...
## change-per-second (dc-utilities::function-or-symbol &optional
                      (dc-utilities::seconds 1))
...
## range (dc-utilities::start dc-utilities::end &key (step 1)
          (dc-utilities::filter #'identity) shuffle)
...
## read-one-line (stream &key (dc-utilities::eol :unix)
                  (dc-utilities::max-length 500))
...
## replace-regexs (dc-utilities::text
                   dc-utilities::list-of-regex-replacement-pairs &key
...
## shell-execute (dc-utilities::program &optional
                  (dc-utilities::parameters nil)
...
## spew (string dc-utilities::filename &key dc-utilities::create-directories
                append)
...
## thread-pool-start (dc-utilities::pool-name dc-utilities::thread-count
                      dc-utilities::job-queue dc-utilities::fn-job &optional
...
## thread-pool-time-to-go (dc-utilities::pool-name
                           dc-utilities::total-record-count)
